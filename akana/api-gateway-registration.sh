...
[{
  ...
  "api-gateway": {
    ...
    "api-admin-emails": ["ajay.2.kumar@monsanto.com","kyle.mcclendon@monsanto.com","kamaraju.prathi@monsanto.com","jonathan.g.gorday@monsanto.com","paul.n.watt@monsanto.com"],
    "groups": ["Monsanto"],
