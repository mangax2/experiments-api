...
ALTER TABLE public.treatment DROP COLUMN in_all_blocks;

ALTER TABLE location_association DROP CONSTRAINT location_association_experiment_id_location_number_block_key;
ALTER TABLE location_association ADD CONSTRAINT location_association_location_number_block_id_key UNIQUE (location, block_id);
ALTER TABLE public.location_association DROP COLUMN block;
ALTER TABLE public.location_association DROP COLUMN experiment_id;
