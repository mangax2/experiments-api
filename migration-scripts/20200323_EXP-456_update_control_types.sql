...
WHERE control_types @> ARRAY['503be58a-8ad6-48d1-ad8d-a2f08f9108e7'];
...
WHERE control_types @> ARRAY['076d9a97-5335-4bd9-9e65-412cc067e327'];
...
WHERE control_types @> ARRAY['59bb9318-c4db-481d-9994-e2a96cab7c3d'];
...
WHERE control_types @> ARRAY['117a22d8-862e-48c5-987f-13ba6ec21733'];
...
WHERE control_types @> ARRAY['4c6c3d5b-7690-41c5-8bdb-7b793ce3fa86'];
...
WHERE control_types @> ARRAY['4b1e7af6-eb81-42d1-a1e3-470ffe907294'];
...
WHERE control_types @> ARRAY['d0f6aa7f-9670-4f1f-882d-6c7aecb4f586'];
...
WHERE control_types @> ARRAY['5cf20c82-fc36-4c4e-8be8-fe445c4d52ba'];
...
WHERE control_types @> ARRAY['76b78379-f6b7-4377-8167-f9ed6717596c'];
...
WHERE control_types @> ARRAY['e957b549-f009-4812-9914-6f59dbf75f33'];
...
WHERE control_types @> ARRAY['f4087e4f-114b-4be0-b3a4-5fb4b87610f9'];
...
WHERE control_types @> ARRAY['f1b066e4-a41c-4efa-8d5d-c073406341b7'];
...
WHERE control_types @> ARRAY['ae504f8d-818e-4283-8ae4-020567efff8a'];
...
WHERE control_types @> ARRAY['0999ee33-6660-47db-b961-6d1411abfa7c'];
...
WHERE control_types @> ARRAY['f8716948-12ac-4891-8096-ea7da4179635'];
...
WHERE control_types @> ARRAY['2e8fe8f1-fd0e-4a44-bdd0-f15d7a7f9abc'];
...
WHERE control_types @> ARRAY['c8b48218-aacb-4716-8c82-9ce35a976757'];
...
WHERE control_types @> ARRAY['a07fe8cd-f538-47fd-a528-0c98ba4ef38c'];
...
WHERE control_types @> ARRAY['96252d4f-ede7-48de-ac23-1fbc9eebfc8a'];
...
WHERE control_types @> ARRAY['54f96a20-0e23-4105-aac1-e34b3b9ea02b'];
...
WHERE control_types @> ARRAY['de7e78bd-e582-426a-a3a2-05d7869947f7'];
...
WHERE control_types @> ARRAY['af6d651d-01c0-4083-8dca-ffed57fb0bcc'];
...
WHERE control_types @> ARRAY['0600526c-039a-4792-924b-3c1f609de1b8'];
