module.exports = (rep, pgp) => ({
  ...
  find: (id, tx = rep) => tx.oneOrNone('SELECT * FROM ref_factor_type WHERE id = $1', id),

  batchFind: (ids, tx = rep) => tx.any('SELECT * FROM ref_factor_type WHERE id IN ($1:csv)', [ids]),

  all: () => rep.any('SELECT * FROM ref_factor_type'),
  ...
  findByBusinessKey: keys => rep.oneOrNone('SELECT * FROM ref_factor_type where type = $1', keys),
