const columns = "gv.id, COALESCE(gv.name, f.name) AS name, COALESCE(gv.value, fl.value->>'level', fl.value->>'refId', fl.value->>'text') AS value, gv.group_id, gv.created_user_id, gv.created_date, gv.modified_user_id, gv.modified_date"
