module.exports = (rep, pgp) => ({
  ...
  batchFindAllTreatmentLevelDetails: (treatmentIds, tx = rep) => tx.any('SELECT ce.treatment_id, fl.value FROM factor_level fl INNER JOIN combination_element ce ON fl.id = ce.factor_level_id WHERE ce.treatment_id IN ($1:csv)', [treatmentIds]),
