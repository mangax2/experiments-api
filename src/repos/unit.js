...
class unitRepo {
  ...
  @setErrorCode('5JJ000')
  batchFindAllByIds = (ids, tx = this.rep) => tx.any('SELECT t.treatment_number, u.treatment_id, u.rep, u.set_entry_id, u.id FROM unit u INNER JOIN treatment t ON u.treatment_id = t.id WHERE u.id IN ($1:csv)', [ids])
