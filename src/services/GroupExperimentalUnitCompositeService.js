...
class GroupExperimentalUnitCompositeService {
  ...
  saveGroupAndUnitDetails(experimentId, groupAndUnitDetails, context, tx) {
    ...
    return this._groupService.deleteGroupsForExperimentId(experimentId, tx).then(() => this._recursiveBatchCreate(experimentId, groupAndUnitDetails, context, tx).then(() => AppUtil.createCompositePostResponse()))
  }
  ...
  _recursiveBatchCreate(experimentId, groupAndUnitDetails, context, tx) {
    ...
    return this._groupService.batchCreateGroups(groups, context, tx).then(groupResp => this._createGroupValuesUnitsAndChildGroups(experimentId, groupResp, groupAndUnitDetails, context, tx))
  }
