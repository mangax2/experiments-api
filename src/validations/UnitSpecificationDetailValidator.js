...
class UnitSpecificationDetailValidator extends SchemaValidator {
    ...
    getSchema(operationName) {
        switch (operationName) {
            case 'POST': return UnitSpecificationDetailValidator.POST_VALIDATION_SCHEMA
            case 'PUT': return UnitSpecificationDetailValidator.POST_VALIDATION_SCHEMA.concat(
