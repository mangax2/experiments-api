...
from .cases import test_scenarios_EXP384
...
def test_scenarios(setup_data, case_data):
    ...
    mismatched = thisSet.loc[(thisSet.catalog_e != thisSet.catalog_s) & (thisSet.catalog_e != placeholderValue), ["catalog_e", "catalog_s", "setName", "entryId", "treatmentId"]]
    ...
    withPlaceHolders = thisSet[(thisSet.catalog_e == placeholderValue)]
