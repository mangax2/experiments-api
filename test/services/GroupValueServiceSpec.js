...
describe('GroupValueService', () => {
  ...
  describe('batchGetGroupValuesByGroupIds', () => {
    it('returns group values for all groups provided', () => {
      const response = [[{ groupId: 1, name: 'repNumber', value: '1' }, {
        groupId: 1,
        name: 'repNumber',
        value: '2',
      }], [{ groupId: 2, name: 'testFactor', value: 'testLevel' }, {
        groupId: 2,
        name: 'testFactor2',
        value: 'testLevel2',
      }]]
  ...
  describe('batchGetGroupValuesByGroupIdsNoValidate', () => {
    it('returns group values', () => {
      let response = [[{ groupId: 1, name: 'repNumber', value: '1' }, {
        groupId: 1,
        name: 'repNumber',
        value: '2',
      }]]
  ...
  describe('batchUpdateGroupValues', () => {
    it('updates group values', () => {
      let response = [{ id: 1, message: 'Resource updated', status: 200 }, {
        id: 2,
        message: 'Resource updated',
        status: 200,
      }]
      validateStub.resolves()
      updateStub.resolves([{ id: 1, name: 'factor1', value: 'testLevel', groupId: 1 }, {
        id: 2,
        name: 'factor2',
        value: 'level2',
        groupId: 1,
      ...
      return groupValueService.batchUpdateGroupValues([{
        id: 1,
        name: 'factor1',
        value: 'testLevel',
        groupId: 1,
